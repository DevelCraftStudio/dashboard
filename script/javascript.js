...
async function handleDashboardReload() {
  ...
  /**
   * Recupera o quiz ativo, busca o dashboard e manda renderizar.
   *
   * dashboard.js é responsável por:
   * - montar o request
   * - chamar a API
   * - tratar fallback temporário
   *
   * dashboard-render.js é responsável por:
   * - atualizar cards
   * - atualizar funil
   * - manipular DOM
   */
